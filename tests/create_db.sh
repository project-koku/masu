...
psql ${DATABASE_NAME} -p ${DATABASE_PORT} -h ${DATABASE_HOST} -U $DB_ADMIN -c 'DROP SCHEMA IF EXISTS acct10001org20002 CASCADE; DROP SCHEMA IF EXISTS public CASCADE;'
...
psql ${DATABASE_NAME} -p ${DATABASE_PORT} -h ${DATABASE_HOST} -U $DB_ADMIN -c "ALTER SCHEMA acct10001org20002 OWNER TO ${DATABASE_USER};"
